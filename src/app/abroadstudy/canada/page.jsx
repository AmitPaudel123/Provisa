...
const page = () => {
  ...
  const livingCost = [
    ...
    "The annual tuition fee for undergraduate students typically ranges between CA$12,000 and CA$25,000. Essentially, it is determined by the course and the institution. Tuition fees for all postgraduate courses vary by course provider, but will be less than CA$35000 per year. The doctoral degree, on the other hand, is quite affordable, costing less than CA$10000 per year. Tuition fees vary depending on the type of qualification and university attended.  ",
  ...
  return (
    <div>
      <AbroadCard
        topic={"Study in Canada"}
        imgsrc={"/abroadstudy.webp"}
        bannerimg={"/studycanada.webp"}
        eduSystem={eduSystem}
        descLists={descLists}
