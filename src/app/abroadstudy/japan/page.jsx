...
const page = () => {
  const descLists = [
    ...
    "Japan has over 700 universities, with 10 ranked in the top 200 worldwide. With high quality of education, no doubt there is over 150,000 international students’ study in Japan. Japan has the world's third-largest economy and is known for its ability to make things smaller, faster, and first. The world is awestruck by Japan's ability to nurture and realize our dreams. Japan's research and development-oriented education system makes a significant contribution.    ",
  ];
